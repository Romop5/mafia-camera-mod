...
//  Read the FAQ about ImTextureID in imgui.cpp. [X] Renderer: Support for large
...
static void ImGui_ImplDX9_SetupRenderState(ImDrawData* draw_data)
{
    ...
    // draw_data->DisplayPos+data_data->DisplaySize (bottom right). Being agnostic
    // of whether <d3dx9.h> or <DirectXMath.h> can be used, we aren't relying on
