...
CGUIButton*	CGUI::CreateButton(int x, int y, unsigned int width, unsigned int height, char* title)
{
...
CGUICheckbox*	CGUI::CreateCheckbox(int x, int y, unsigned int width, unsigned int height, bool state)
{
...
CGUITableList*	CGUI::CreateTableList(int x, int y, unsigned int width, unsigned int height)
{
...
CGUIEditbox*	CGUI::CreateEditbox(int x, int y, unsigned int width, unsigned int height, char* text)
{
...
CGUIWindow*		CGUI::GUICreateWindow(int x, int y, unsigned int width, unsigned int height, char* text)
{
...
CGUIElement*	CGUI::GetInputElement()
{
	return this->elementInput;
}

CGUIElement*	CGUI::GetHoverElement()
{
	return this->elementHover;
}


bool			CGUI::IsInputActive()
{
...
void CGUI::OnRender()
{
	...
	*/
	//core->getGraphics()->TextDraw(500, 300, debug, D3DCOLOR_XRGB(255, 255, 255));
}
